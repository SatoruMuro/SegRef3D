...
test("offline cache uses the current UI asset generation", async () => {
  ...
  assert.match(html, /app\.mjs\?v=54/);
  assert.match(html, /<script type="module" src="\.\/app\.mjs\?v=54"><\/script>/);
  ...
  assert.match(worker, /segref3d-lite-web-v59/);
  ...
  assert.match(worker, /app\.mjs\?v=54/);
  ...
  assert.match(worker, /workspace-ui\.mjs\?v=34/);
